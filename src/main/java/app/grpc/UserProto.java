...
public final class UserProto {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return app.grpc.UserProto.internal_static_LoginRequest_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return app.grpc.UserProto.internal_static_LoginRequest_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              app.grpc.UserProto.LoginRequest.class, app.grpc.UserProto.LoginRequest.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof app.grpc.UserProto.LoginRequest)) {
    ...
    public static app.grpc.UserProto.LoginRequest parseFrom(
    ...
    public static app.grpc.UserProto.LoginRequest parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static app.grpc.UserProto.LoginRequest parseFrom(
    ...
    public static app.grpc.UserProto.LoginRequest parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static app.grpc.UserProto.LoginRequest parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static app.grpc.UserProto.LoginRequest parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(app.grpc.UserProto.LoginRequest prototype) {
    ...
    public static final class Builder extends
        ...
        app.grpc.UserProto.LoginRequestOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return app.grpc.UserProto.internal_static_LoginRequest_descriptor;
      }
      ...
      // Construct using app.grpc.UserProto.LoginRequest.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public app.grpc.UserProto.LoginRequest getDefaultInstanceForType() {
        return app.grpc.UserProto.LoginRequest.getDefaultInstance();
      }

      @java.lang.Override
      public app.grpc.UserProto.LoginRequest build() {
        app.grpc.UserProto.LoginRequest result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof app.grpc.UserProto.LoginRequest) {
          return mergeFrom((app.grpc.UserProto.LoginRequest)other);
        } else {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        app.grpc.UserProto.LoginRequest parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (app.grpc.UserProto.LoginRequest) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final app.grpc.UserProto.LoginRequest DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new app.grpc.UserProto.LoginRequest();
    }

    public static app.grpc.UserProto.LoginRequest getDefaultInstance() {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return app.grpc.UserProto.internal_static_LoginResponse_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return app.grpc.UserProto.internal_static_LoginResponse_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof app.grpc.UserProto.LoginResponse)) {
        return super.equals(obj);
      }
    ...
    public static app.grpc.UserProto.LoginResponse parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static app.grpc.UserProto.LoginResponse parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static app.grpc.UserProto.LoginResponse parseFrom(
    ...
    public static app.grpc.UserProto.LoginResponse parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static app.grpc.UserProto.LoginResponse parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static app.grpc.UserProto.LoginResponse parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(app.grpc.UserProto.LoginResponse prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        ...
        app.grpc.UserProto.LoginResponseOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return app.grpc.UserProto.internal_static_LoginResponse_descriptor;
      }
      ...
      // Construct using app.grpc.UserProto.LoginResponse.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      @java.lang.Override
      public app.grpc.UserProto.LoginResponse getDefaultInstanceForType() {
        return app.grpc.UserProto.LoginResponse.getDefaultInstance();
      }

      @java.lang.Override
      public app.grpc.UserProto.LoginResponse build() {
        app.grpc.UserProto.LoginResponse result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof app.grpc.UserProto.LoginResponse) {
          return mergeFrom((app.grpc.UserProto.LoginResponse)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        app.grpc.UserProto.LoginResponse parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (app.grpc.UserProto.LoginResponse) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final app.grpc.UserProto.LoginResponse DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new app.grpc.UserProto.LoginResponse();
    }

    public static app.grpc.UserProto.LoginResponse getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
